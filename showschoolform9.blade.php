                ...
                <tr>
                    @if($student[0]->acadprogid != 5)
                        <td width="50%" >
                            ...
                            @if( count($grades) != 0)
                                @php
                                    $genaverage =  (collect($grades)->avg('quarter1') + collect($grades)->avg('quarter2') + collect($grades)->avg('quarter3') + collect($grades)->avg('quarter4')) / 4 ;
                                @endphp
                            @else
                                @php
                                    $genaverage = null;    
                            ...
                            <tr class="table-bordered genave">
                                    ...
                                    @if($quarter1complete)
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">{{round(collect($grades)->avg('quarter1'))}}</td>
                                    @else
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">&nbsp;</td>
                                    @endif

                                    @if($quarter2complete)
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">{{round(collect($grades)->avg('quarter2'))}}</td>
                                    @else
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">&nbsp;</td>
                                    @endif
                                
                                    @if($quarter3complete)
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">{{round(collect($grades)->avg('quarter3'))}}</td>
                                    @else
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">&nbsp;</td>
                                    @endif

                                    @if($quarter4complete)
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">{{round(collect($grades)->avg('quarter4'))}}</td>
                                    @else
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">&nbsp;</td>
                                    @endif
