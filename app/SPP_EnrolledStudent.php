    ...
    public static function getStudent(
        ...
        if($acadprogid == 5){
            ...
            if($type == 'all'){
                ...
                $students->select('sh_enrolledstud.promotionstatus','sh_enrolledstud.studstatus as enstudstat','sh_enrolledstud.sectionid');
        ...
        elseif($acadprogid == 6){
            ...
            if($type == 'all'){
                ...
                $students->select('college_enrolledstud.promotionstatus','college_enrolledstud.studstatus as enstudstat','college_enrolledstud.sectionid');
            ...
            if($type == 'all'){
                ...
                $students->select('enrolledstud.promotionstatus','enrolledstud.studstatus as enstudstat');
