...
class SPP_ClassSchedule extends Model
{
    ...
    */
    ...
    public static function evaluateInsertedInformation($request){
        ...
        if(count($inClassSched)==0){
            ...
            foreach($request->get('days') as $day){
                ...
                $detail = DB::table('classscheddetail')
                            ->where('headerid',$inClassSched[0]->id)
    ...
    public static function evaluateInsertedInformationv2($request){
