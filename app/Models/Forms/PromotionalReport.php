        ...
        foreach($courses as $item){
            ...
            foreach($enrolled_stud as $enrolled_stud_item){
                ...
                $sched = DB::table('college_studsched')
                            ...
                            ->leftJoin('college_studentprospectus',function($join) use($enrolled_stud_item){
                ...
                $middle = isset($enrolled_stud_item->middlename) ? ' '.$enrolled_stud_item->middlename[0].'.' : '';
