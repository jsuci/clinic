...
class HighSchool extends Model
{
      ...
      public static function grade_info(
            ...
            // $grading_system = GradingSystem::evaluate_grading_system_highschool($gsid);
            ...
            return view('superadmin.pages.gradingsystem.hs_grading')
      ...
      public static function evaluate_student_grade(
            ...
            $check_subeject_gs = DB::table('grading_system_grades_hs')
                                    ->where('grading_system_grades_hs.sectionid',$sectionid)
                                    ->where('grading_system_grades_hs.subjid',$subjectid)
                                    ->where('grading_system_grades_hs.deleted',0)
                                    ->where('studid',0)
                                    ->where('syid',$activeSy->id)
                                    ->join('grading_system_detail',function($join){
                                          $join->on('grading_system_grades_hs.gsdid','=','grading_system_detail.id');
            ...
            $gsheader = DB::table('grading_system_grades_hs')
                                    ->where('studid',0)
                                    ->where('syid',$activeSy->id)
            ...
            return view('superadmin.pages.gradingsystem.hs_grading_table')
      ...
      public static function generate_student_grade(
            ...
            foreach($grading_system_detail as $item){
                  ...
                  $gsgradescount = DB::table('grading_system_grades_hs')
                              ->where('gsdid',$item->id)
                              ->where('studid',$studid)
      ...
      public static function submit_student_grade(
            ...
            $gradeDetail = DB::table('grading_system_grades_hs')
                                    ->where('grading_system_grades_hs.deleted',0)
                                    ->where('studid',$studid)
                                    ->where('id',$gradid);
            ...
            $hps = DB::table('grading_system_grades_hs')
                              ->where('studid',0)
            ...
            $studentgsd =   DB::table('grading_system_grades_hs')
                              ->where('grading_system_grades_hs.deleted',0)
                              ->where('studid',$studid)
                              ->where('id',$gradid);
      ...
      public static function calcig($student = null, $syid = null, $subject = null, $section = null, $quarter = null){
            ...
            $studgd = DB::table('grading_system_grades_hs')
      ...
      public static function view_sf9(
            ...
            $pdf = PDF::loadView('teacher.grading.sf9forms.hssf9',compact('nogscount','schoolinfo','schoolyear','gsheader','quarter','checkStatus','gradelevel','gsd','grading_system_detail','students','teacher','section','subjectStatus'))->setPaper('legal', 'landscape',);
      ...
      public static function reload_student_grade(
            ...
            if(isset($check_subeject_gs->headerid)){
                  ...
                  if($grading_system[0]->id != $check_subeject_gs->headerid){
                        ...
                        $get_studentgrades_detail = $check_subeject_gs = DB::table('grading_system_grades_hs')
                                                                              ->where('grading_system_grades_hs.sectionid',$sectionid)
                                                                              ->where('grading_system_grades_hs.subjid',$subjectid)
                                                                              ->where('grading_system_grades_hs.deleted',0)
                                                                              ->where('studid',$student)
                                                                              ...
                                                                              ->select('grading_system_grades_hs.*','grading_system_detail.sf9val')
                                                                              ->where('syid',$activeSy->id)
                                                                              ->get();
      ...
      public static function reCalculateGrade($studid = null, $sectionid = null, $subjid = null, $quarter = null ){
            ...
            $gradeDetailHPS = DB::table('grading_system_grades_hs')
                                    ->where('studid',0)
                                    ->where('sectionid',$sectionid)
                                    ->where('subjid',$subjid)
                                    ->where('syid',self::activeSy())
      ...
      public static function evaluate_student_grade_highschool_pending(
            $gsid = null,
            $studid = null,
            $sectionid = null,
            $subjectid = null,
            ...
            return view('teacher.pendinggrades.v2.hspending')
                        ->with('nogscount',$nogscount)
                        ->with('gsheader',$gsdetail)
                        ->with('quarter',$quarter)
                        ->with('gradelogs',$gradelogs)
