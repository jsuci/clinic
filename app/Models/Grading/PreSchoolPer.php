...
class PreSchoolPer extends Model
{
      ...
      public static function section_count($teacherid = null){
            ...
            $sections = DB::table('assignsubj')
                              ...
                              ->join('gradelevel',function($join){
                                    ...
                                    $join->where('gradelevel.acadprogid',self::acadprog());
                              })
      ...
      public static function get_sections($teacherid = null){
      ...
      public static function evaluate_student_grade_gradeschool(
            ...
            $check_subeject_gs = DB::table('grading_system_grades_psper')
                                    ->where('grading_system_grades_psper.sectionid',$sectionid)
                                    ->where('grading_system_grades_psper.subjid',$subjectid)
                                    ->where('grading_system_grades_psper.deleted',0)
                                    ->where('studid',0)
                                    ->where('syid',$activeSy->id)
                                    ->whereNotNull('levelid')
                                    ->join('grading_system_detail',function($join){
                                          $join->on('grading_system_grades_psper.gsdid','=','grading_system_detail.id');
            ...
            foreach($students as $item){
                  ...
                  $gsdget = DB::table('grading_system_grades_psper')
            ...
            $gsheader = DB::table('grading_system_grades_psper')
                                    ->where('studid',0)
                                    ->where('syid',$activeSy->id)
            ...
            return view('superadmin.pages.gradingsystem.ps_per_grading_table')
      ...
      public static function generate_student_grade_gradeschool(
            ...
            foreach($grading_system_detail as $item){
                  ...
                  $gsgradescount = DB::table('grading_system_grades_psper')
                              ->where('gsdid',$item->id)
                              ->where('sectionid',$sectionid)
                              ->where('studid',$studid)
      ...
      public static function submit_student_grade_gradeschool(
            ...
            $gradeDetail = DB::table('grading_system_grades_psper')
                                    ->where('studid',$studid)
                                    ->where('grading_system_grades_psper.deleted',0)
                                    ->where('id',$gradid);
            ...
            $hps = DB::table('grading_system_grades_psper')
                              ->where('studid',0)
            ...
            $studentgsd =   DB::table('grading_system_grades_psper')
                              ->where('studid',$studid)
                              ->where('grading_system_grades_psper.deleted',0)
                              ->where('id',$gradid);
      ...
      public static function calcig($student = null, $syid = null, $subject = null, $section = null, $quarter = null){
            ...
            $studgd = DB::table('grading_system_grades_psper')
      ...
      public static function reload_student_grade(
            ...
            if(isset($check_subeject_gs->headerid)){
                  ...
                  if($grading_system[0]->id != $check_subeject_gs->headerid){
                        ...
                        $get_studentgrades_detail = $check_subeject_gs = DB::table('grading_system_grades_psper')
                                                                              ->where('grading_system_grades_psper.sectionid',$sectionid)
                                                                              ->where('grading_system_grades_psper.subjid',$subjectid)
                                                                              ->where('grading_system_grades_psper.deleted',0)
                                                                              ->where('studid',$student)
                                                                              ...
                                                                              ->select('grading_system_grades_psper.*','grading_system_detail.sf9val')
                                                                              ->where('syid',$activeSy->id)
                                                                              ->get();
      ...
      public static function reCalculateGrade($studid = null, $sectionid = null, $subjid = null, $quarter = null ){
            ...
            $gradeDetailHPS = DB::table('grading_system_grades_psper')
                                    ->where('studid',0)
                                    ->where('sectionid',$sectionid)
                                    ->where('subjid',$subjid)
                                    ->where('syid',self::activeSy())
      ...
      public static function view_sf9(
            ...
            $pdf = PDF::loadView('teacher.grading.sf9forms.gssf9',compact('nogscount','schoolinfo','schoolyear','gsheader','quarter','checkStatus','gradelevel','gsd','grading_system_detail','students','teacher','section'))->setPaper('legal', 'landscape');
