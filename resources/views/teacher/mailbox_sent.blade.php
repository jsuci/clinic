          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0" style="overflow: scroll">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm trashbtn"><i class="far fa-trash-alt"></i></button>
                </div>
              </div>
                  ...
                  <tbody>
                    ...
                    @endphp
                      ...
                      <tr>
                        ...
                        <td class="mailbox-subject" style=" white-space: nowrap !important;overflow: hidden !important;text-overflow: ellipsis !important;">
                            
                            <form name="read" action="/mailbox/read/{{Crypt::encrypt(auth()->user()->id)}}" method="get" >
                                <input type="hidden" name="message_id" value="{{$inbox['message']->id}}"/>
                                {{-- <input type="hidden" name="message_notificationid" value="{{$inbox['message']->notificationid}}"/> --}}
                                <input type="hidden" name="message_date" value="{{$inbox['message']->created_at}}"/>
                                <input type="hidden" name="message" value="deletesent"/>
                                <strong>
                                    <a type="button" class="submitBtn{{$unique}} btn-block" style=" white-space: nowrap !important;overflow: hidden !important;text-overflow: ellipsis !important;">
                                        <b>{{$inbox['message']->title}}</b>
                                        <br>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="/mailbox/delete/sent" method="get">
