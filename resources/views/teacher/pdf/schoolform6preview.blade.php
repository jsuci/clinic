...
@endphp
    <table id="header">
        <tr>
            <th rowspan="3" style="width:10%;" class="leftImg">
            ...
            <td colspan="8" style="padding-top:0px;"><div style="padding-right:7%;margin-top: 0px;padding-top:0px;"><center><h3 style="font-size:15px !important;">School Form 6 (SF6)<br>Summarized Report on Promotion and Level of Proficiency</h3><sup><em>(This replaces Form 20)</em></sup></center><br></div></td>
        </tr>
        <tr>
            ...
            {{-- <th>District</th>
            <th colspan="2"><div class="box">{{$school[0]->district}}"/></th> --}}
            <th></th>
        </tr>
        <tr>
            <th>School Name</th>
            ...
            <th>District</th>
            <th><div class="box">{{$getSchoolInfo[0]->district}}</div></th>
            <th>School Year</th>
    ...
    <table style="table-layout:fixed;width:100%;font-size:11px;">
        <tr>
            ...
            <td style="border-top: hidden; border-bottom: 1px solid black;border-left:hidden; border-right: hidden; !important;padding:5px"><center><small>{{$getPrincipal[0]->lastname}}, {{$getPrincipal[0]->firstname}} {{$getPrincipal[0]->middlename[0]}} {{$getPrincipal[0]->suffix}}</small></center></td>
            <th style="padding:5px;border:hidden;text-align:right"><small>Reviewed & Validated by:</small></th>
            <td style="padding:5px;border-bottom: 1px solid black;border-top:hidden;text-align:center;text-transform: uppercase"><small>{{$divisionRep}}</small></td>
            <th style="padding:5px;border:hidden;text-align:right;width:10%"><small>Noted by:</small></th>
            <td style="padding:5px;border-right:hidden;border-bottom: 1px solid black;border-top:hidden;text-align:center;text-transform: uppercase" >{{$divisionSup}}</td>
        </tr>
        <tr>
...
<div style="width:100%;font-size:11px;margin:0px;padding-top: 0px;">
    <p style="padding-top:0px; margin-top:0px;"><strong>GUIDELINES:</strong></p>
