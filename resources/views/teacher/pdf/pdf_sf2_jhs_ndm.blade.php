        ...
        <td style="width:20%;padding-left:10px;" valign="top">
            <table class="summary" style="font-size:8px;table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td>
                        @php
                            if($pammale > 0 && $pamfemale > 0)
                            {
                                $totalpam = ($pammale+$pamfemale)/2;
                            }else{
                                $totalpam = $pammale > 0 ? $pammale : $pamfemale;
                            }
                        @endphp
                        {{$totalpam}}
                    </td>
            ...
            <div style="font-size: 11px; text-align:center;padding-top: 2px;">
                <center>
                    ...
                    @if(DB::table('schoolinfo')->first()->abbreviation == 'mcs')@if(auth()->user()->id == 22), LPT @endif @endif
