<html>
    ...
    <body>
        {{-- <h3><center>School Form 5 (SF5) Report on Promotion and Learning Progress & Achievement</center></h3>
        <sup style="font-size: 10px;"><em><center>Revised to confom with the instructions of Deped Order 8, s. 2015</center></em></sup> --}}
        <table id="header" style="margin-top: 25px;">
            <tr style="line-height: 7px;">
                <th colspan="10" style="font-size: 20px;"><center>School Form 5 (SF5) Report on Promotion and Learning Progress & Achievement</center>
                <br/>
                <em style="font-size: 11px;"><center>Revised to confom with the instructions of Deped Order 8, s. 2015</center></em>
            </th>
            </tr>
            <tr>
                ...
                <td id="cellCenter"><div class="box">{{str_replace('REGION', '', $getSchoolInfo[0]->region)}}</div></td>
                <td class="labels">Division</td>
                <td colspan="2" id="cellCenter"><div class="box">{{str_replace('CITY', '', $getSchoolInfo[0]->division)}}</div></td>
        ...
        <table style="width: 100%; page-break-inside: auto; table-layout: fixed;">
            <tr nobr="true">
                <td style="width: 70%; vertical-align: top; padding: 0px; page-break-inside: auto; font-size: 11px;">
                    <table style="width: 100%; border-collapse: collapse; page-break-inside: auto; margin: 0px;" border="1">
                        <thead>
                            <tr style="font-size: 10px;">
                                <th style="width: 15%;" rowspan="2">LRN</th>
                                <th style="width: 25%;" rowspan="2">LEARNER'S NAME<br><sup>(Last Name, First Name, Middle Name)</sup></th>
                                <th style="width: 10%;" rowspan="2">GENERAL<br>AVERAGE</th>
                                <th style="width: 15%;" rowspan="2">ACTION TAKEN:<br>PROMOTED,<br>CONDITIONAL, or<br>RETAINED</th>
                                <th colspan="2">INCOMPLETE SUBJECTS</th>
                            </tr>
                            <tr>
                ...
                <td style="vertical-align: top; padding-top: 70px; font-size: 11px;">
        ...
        <table style="width: 100%; page-break-inside: auto; table-layout: fixed;">
            <tr nobr="true">
                ...
                <td style="vertical-align: top;font-size: 11px; padding-top: 30px; padding-left: 15px;">
