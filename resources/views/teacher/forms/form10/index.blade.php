                  ...
                  $.ajax({
                    ...
                    }, success:function(data)
                    {
                        ...
                        if(data.length == 0)
                        {
                            ...
                            $('#acadprog-selection').append(
                                '<div class="row mb-2"><div class="col-12"><a href="/reports_schoolform10/view?studentid='+studentid+'&acadprogid='+value.id+'&acadprogname='+value.description+'&sectionid={{$info[0]->sectionid}}" type="button" class="btn btn-lg btn-default btn-block">'+value.description+'</a></div></div>'
                            );
                            })
                        }
                    }
