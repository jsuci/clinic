                ...
                <div class="card-body">
                    <table id="header" class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th><input type="text" value="{{$sy[0]->sydesc}}" readonly/></th>
                            </tr>
                        </thead>
                    </table>
                    <br>
                    ...
                    <table class="table" style="border: 1px solid black !important;table-layout:fixed;">
                        <tr>
                            ...
                            <td style="border-top: hidden; border-bottom: 1px solid black;border-left:hidden; border-right: hidden; !important;padding:5px"><center><small>
                                @if(isset($principalname))
                                {{$principalname[0]->lastname}}, {{$principalname[0]->firstname}} {{$principalname[0]->middlename[0]}} {{$principalname[0]->suffix}}
                            @endif
                        </small></center></td>
