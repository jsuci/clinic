        ...
        <!-- end gian -->
            ...
            @else
                <div class="card-body">
                    ...
                    @if(isset($attendancepersection))
                    @if($count == $promoted)
                    @else
                    <form action="/classAttendance" method="POST" name="formSubmit" >
                    @endif
                    @endif
                        ...
                        @if(isset($attendance))
                            <div class="col-sm-12">
                                <div style="overflow-x:auto;" >
                                    {{-- @if(isset($present)) --}}
                                    <div class="btn btn-default btn-sm">Total Female <span id="presentBadge" class="badge badge-pill badge-secondary">{{$female}}</span>
                                    </div>
                                    <div class="btn btn-default btn-sm">Total Male <span id="presentBadge" class="badge badge-pill badge-secondary">{{$male}}</span>
                                    </div>
                                    <br>
                                    <br>
                                    ...
                                    @if(isset($attendance))
                                        ...
                                        @else
                                            @if(isset($checkdate))
                                                @if($checkdate == 0)
                                                    <button type="submit" id="savebutton" class="btn btn-success btn-sm float-right " >Save&nbsp;<i class="fa fa-upload"></i>
                                                    </button>
                                                @else
                                                    <button type="submit" id="savebutton" class="btn btn-warning btn-sm float-right " >Update&nbsp;<i class="fa fa-edit"></i>
                                                    </button>   
                                                @endif
                                            @endif
                                        @endif
                    ...
                    success:function(data) {
                        ...
                        console.log(value)
                                ...
                                if(value.promotionstatus == 1){
                                    ...
                                    .append(
                                        '<tr>'+
                                            '<td>'+ value.lastname+', '+value.firstname+' '+middlename+'</td>'+
                                            '<th scope="row">'+
                                                '<center>'+
                                                    '<div class="icheck-success d-inline">'+
