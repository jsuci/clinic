                        ...
                        <div class="col-sm-12">
                              <div class="card">
                                    <div class="card-header">
                                          ...
                                          <h3 class="card-title">COLLEGE GRADES STATUS</h3>
                                          <div class="card-tools">
                                                <div class="input-group input-group-sm" style="width: 150px;">
                                                <input type="text" name="search" class="form-control float-right" placeholder="Search" id="search" value="">
            ...
            <script>
                  ...
                  $(document).ready(function(){
                        ...
                        function processpaginate(skip = null,take = null ,search = null, firstload = true){
                              ...
                              $.ajax({
                                    type:'GET',
                                    url:'/dean/view/all/grades?take='+take+'&skip='+skip+'&table=table'+'&search='+$('#search').val(),
                        ...
                        function loadgrades(){
                              ...
                              $.ajax({
                                    type:'GET',
                                    url:'/dean/view/all/grades?viewgrade=viewgrade&gradeid='+gradeId+'&term='+gradeTerm,
                                    success:function(data) {
