        ...
        <table class="table" width="100%">
                <tr>
                    ...
                    <td width="50%" style="padding-left: .25in !important" >
                        <table class="table table-sm" width="100%">
                            <tr>
                                <td class="text-right p-0" style="font-size: 9px !important"><b>DepEd FORM 138-A</b></td>
                            </tr>
                            <tr>
                                <td class="text-right p-0" style="font-size: 9px !important"><b>Gov. Recognition No. 128, s.1969
                                </b></td>
                            </tr>
                        </table>
                        <table class="table table-sm" width="100%">
