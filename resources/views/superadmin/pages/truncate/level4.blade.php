          ...
          <div class="col-12">
            <div class="card adminrooms">
              <div class="card-header bg-info">
                <h5>Truncanator Level 4</h5>
              </div>
              <div class="card-body">
                    <form action="/truncatelevel4">
                        ...
                        <div class="form-group">
                              <div class="icheck-success d-inline">
                                    ...
                                    <p class="ml-5 small mb-0">FOR EVALUATION: <em class="text-primary"></em></p>
                                    <p class="ml-5 small mt-0">
                                          @if($principalstatus)
                                                STATUS: <span class="badge badge-danger"><b style="font-size:15px">NOT CLEARED</b></span>
                                          @else
                                                STATUS: <span class="badge badge-success"><b style="font-size:15px">CLEARED</b></span>
                                          @endif
                                    </p>
                              </div>
                        </div>
                        ...
                        <div class="form-group">
                              <div class="icheck-success d-inline">
                                    <input type="checkbox" id="registrar" name="registrar" value="true" >
                                    <label for="registrar">REGISTRAR</label>
                                    <p class="ml-5 small mb-0">AFFECTED TABLES: <em class="text-danger"></em></p>
                                    <p class="ml-5 small mb-0">FOR EVALUATION: <em class="text-primary"></em></p>
                                    <p class="ml-5 small">
                                          @if($registrarclearStatus)
                                                STATUS: <span class="badge badge-danger"><b style="font-size:15px">NOT CLEARED</b></span>
                                          @else
                                                STATUS: <span class="badge badge-success"><b style="font-size:15px">CLEARED</b></span>
                                          @endif
