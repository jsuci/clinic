...
@section('footerjavascript')
      <script>
            $(document).ready(function(){
                  ...
                  load_preschool_grading_question_table()
                  ...
                  function load_preschool_grading_question_table(){

                        $.ajax({
                              type:'GET',
                              url:'/preschoolquestionsetup?table=table',
                              success:function(data) {
                                    $('#pre-school_grading_question_table').empty()
                                    $('#pre-school_grading_question_table').append(data)
                              }
                        })   
                  ...
                  $(document).on('click','.edit',function(){
                        ...
                        $.ajax({
                              type:'GET',
                              url:'/preschoolquestionsetup?info=info&id='+$(this).attr('data-value'),
                              success:function(data) {
                  ...
                  $(document).on('click','#save_button',function(){
                        ...
                        $.ajax({
                              type:'GET',
                              url:'/preschoolquestionsetup?'+proccess+'='+proccess+'&question='+$('input[name="evalquestion"]').val()+'&question_id='+selected_question,
                              success:function(data) {
                  ...
                  $(document).on('click','.delete',function(){
                        ...
                        $.ajax({
                              type:'GET',
                              url:'/preschoolquestionsetup?'+proccess+'='+proccess+'&question_id='+selected_question,
                              success:function(data) {
