...
<script>
      ...
      $(document).ready(function(){
            ...
            $(document).on('change','#section_list',function(){
                  ...
                  $('#student_test').empty()
                  $('#student_test').append('<option value="">Select Student</option')
                  ...
                  $.each(students,function(a,b){
                        ...
                        if(b.sectionid == sect){
                              ...
                              $('#student_test').append('<option value="'+b.id+'">'+b.lastname+', '+b.firstname+'</option')
            ...
            $('#eval_student_grade').unbind().click(function(){
