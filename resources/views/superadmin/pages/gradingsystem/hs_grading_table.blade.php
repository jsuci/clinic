@if (count($students) > 0)
      ...
      <table class="table table-bordered" id="grade_info_hs" data-id="{{$gsd->id}}">
            <tr>
                  <td with="40%"><label class="mb-0">Grading System:</label> {{$gsd->description}}</td>
                  <th colspan="2">
      ...
      <div class="table-responsive p-0" style="height: 470px">
            <table class="gradestable table tableFixHead"  data-levelid="{{$gradelevel}}">
                  <thead>
                        <tr>
