...
<hr>
<div class="row">
      {{-- @if($grading_system[0]->type == 1 && $grading_system[0]->specification == 1) --}}
            ...
            <div class="col-md-4 form-group">
                  ...
                  <select name="" id="t_s_subject" class="form-control select2">
                        ...
                        {{-- @foreach ( $subjects as $item)
                              <option value="{{$item->subjid}}" data-main="0" >{{$item->subjcode}}</option>
                        @endforeach --}}
                  </select>
            </div>
            <div class="col-md-4 form-group">
...
<div class="row mt-5">
      <div class="col-md-12 p-0" id="pstable_holder">

      </div>
</div>
<div class="row mt-5">
      <div class="col-md-12">
            <button class="btn btn-primary" id="save_grades_gs" hidden>
...
{{-- @if($grading_system[0]->type == 1 && $grading_system[0]->specification == 1) --}}
      ...
      <script>
            ...
            $(document).ready(function(){
                  ...
                  var failedCount = 0;
                  var proccessCount = 0;
                  var url = '/reportcard/grades/gradeschool';
                              ...
                              $.ajax({
                                    ...
                                    success:function(data) {
                                          ...
                                          if(  proccessCount  == itemCountTotal){
                                                ...
                                                $('.ge').removeClass('ge')
                                                itemCountTotal = 0
                                                $('#save_grades_gs').removeAttr('disabled')
                                                loadGradesDetail()
                  ...
                  $('#save_grades_gs').unbind().click(function(){
