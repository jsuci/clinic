      ...
      <div class="container-fluid">
            ...
            <div class="row">
                  <div class="col-md-12">
                        <div class="card shadow" >
                              <div class="card-header">
                                    <h5 class="card-title">Prekinder Title</h5>
                              </div>
                              <div class="card-body">
                                    <div class="row ">
                                          <div class="col-md-12">
...
@section('footerjavascript')
      ...
      <script>
            $(document).ready(function(){
                  ...
                  function udpate_1(){
                        ...
                        $.ajax({
                              type:'GET',
                              url: '/grade/prekinder/setup/update',
                              data:{
                                    syid:3,
                                    dataid:dataid,
                  ...
                  $(document).on('click','.delete',function () {
                        ...
                        $.ajax({
					type:'GET',
					url: '/grade/prekinder/setup/delete',
                              data:{
                                    dataid:temp_dataid,
                                    syid:3
                              },
                  ...
                  function create_1(){
                        ...
                        $.ajax({
					type:'GET',
					url: '/grade/prekinder/setup/create',
                              data:{
                                    syid:3,
                                    type:type,
                                    dataid:dataid,
      ...
      <script>
            $(document).ready(function(){
                  ...
                  $(document).on('click','#button_to_modal_2',function () {
                        dataid = ""
                        action = "create"
                        $('#create_button_2')[0].innerHTML = '<i class="fas fa-plus"></i> Create'
                        $('#create_button_2').addClass('btn-primary')
                        $('#create_button_2').removeClass('btn-success')
                        $('#description').val("")
                        $('#header').prop('checked',false)
                        $('#modal_2').modal('show')
                  })

                  $(document).on('click','.create_item_2',function () {
                        action = "create"
                        action = "create"
                        $('#create_button_1')[0].innerHTML = '<i class="fas fa-plus"></i> Create'
                        $('#create_button_1').addClass('btn-primary')
                  ...
                  $(document).on('click','#create_button_2',function () {
                        if(action == "create"){
                              create_2()
                        }else{
                              udpate_2()
                  ...
                  $(document).on('click','.edit',function () {
                        action = "update"
                        $('#create_button_2')[0].innerHTML = '<i class="fas fa-edit"></i> Update'
                        $('#create_button_2').removeClass('btn-primary')
                        $('#create_button_2').addClass('btn-success')
                  ...
                  function plot_setup(data) {
                        ...
                        $.each(data,function(a,b){
                              ...
                              if(b.value == 0){
                                    header = 'font-weight-bold'
                                    button = '<button class="create_item_2 btn btn-sm btn-primary" data-id="'+b.id+'"><i class="fas fa-plus"></i> Add Item</button>'
