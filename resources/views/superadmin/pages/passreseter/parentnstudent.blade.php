                  ...
                  <div class="col-12">
                        <div class="card">
                              <div class="card-header bg-info ">
                                    <span class="text-white h4"><b>Parent and Student Password Resetter</b></span>
      ...
      <script>
            $(document).ready(function(){
                  ...
                  function processpaginate(skip = null,take = null ,search = null, firstload = true){
                        $.ajax({
                              type:'GET',
                              url:'/passwordresseter?take='+take+'&skip='+skip+'&table=table'+'&search='+search+'&studentnparent=studentnparent',
                              success:function(data) {
