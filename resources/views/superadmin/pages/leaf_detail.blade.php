        ...
        <section class="content pt-2">
            <div class="container-fluid">
                  ...
                  <form action="/superadmin/leaf/submit" method="GET" id="survey_form" autocomplete="off">
                ...
                <div class="row">
                        ...
                        <div class="card-body">
                              <div class="row">
                                    ...
                                    <div class="col-md-4 text-right">
										<button type="button" class="btn btn-primary" id="btn-exporttopdf">Export to PDF</button>
                                    </div>
                              </div>
                              <hr>
                              <div class="row">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-8 pt-2">
                                          ...
                                          <div class="icheck-primary d-inline ml-3">
                                                <input type="radio" id="a3b" name="a3" value="2" {{$surveyAns->a3 ? 'checked':''}}>
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                      <input name="a7" class="form-control required input_field" value="{{isset($surveyAns->a7) ?  $surveyAns->a7 : $student->lastschoolatt}}" id="a7" placeholder="Last School Attended" onkeyup="this.value = this.value.toUpperCase();">
                                      <span class="invalid-feedback" role="alert">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">B10. Belonging to Indigenous Community/Indigenous Cultural Community: </label>
                                    <div class="col-sm-8 pt-2">
                                          <div class="icheck-primary d-inline">
                                                <input type="radio" id="b10a" name="b10" value="1" @if($surveyAns->b10 == 1 || isset($student->studethnic)) checked="checked" @endif>
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                          <input class="form-control" id="b11" name="b11" placeholder="If yes, please specify" value="{{isset($surveyAns->b11) ? $surveyAns->b11 : $student->studethnic}}" onkeyup="this.value = this.value.toUpperCase();">
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">B12. Mother Tongue: </label>
                                    <div class="col-sm-8">
                                          <input onkeyup="this.value = this.value.toUpperCase();" class="form-control input_field required" id="b12" name="b12" placeholder="Mother Tongue" value="{{isset($surveyAns->b12) ? $surveyAns->b12 : $student->studmt}}">
                                          <span class="invalid-feedback" role="alert">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                          <input onkeyup="this.value = this.value.toUpperCase();" class="form-control input_field required" id="b13" name="b13" placeholder="Religion" value="{{isset($surveyAns->b13) ? $surveyAns->b13 : $student->studrel}}">
                                          <span class="invalid-feedback" role="alert">
                              ...
                              <div class="form-group row">
                               ...
                               <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">B19. Subdivision/ Village/ Zone: </label>
                                    <div class="col-sm-8">
                                          <input class="form-control input_field required" id="b23" name="b23" placeholder="House Number and Street" value="{{$surveyAns->b23}}" onkeyup="this.value = this.value.toUpperCase();">
                                          <span class="invalid-feedback" role="alert">
                                                <strong>B23 is required.</strong>
                                             </span>
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">B20. Barangay: </label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">B21. City/ Municipality: </label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">B22. Province: </label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">B23. Region: </label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                          <select name="c2" id="c2" class="form-control">
                                                ...
                                                <option value="3" @if($surveyAns->c2 == 3) selected @endif>College graduate</option>
                                                <option value="4" @if($surveyAns->c2 == 4) selected @endif">Vocational</option>
                                                <option value="5" @if($surveyAns->c2 == 5) selected @endif">Master’s/Doctorate degree</option>
                                                <option value="6" @if($surveyAns->c2 == 6) selected @endif">Did not attend school</option>
                                          </select>
                                    </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                          <input class="form-control" id="c5" name="c5" placeholder="Father's Contact number/s (cellphone/ telephone)" value="{{isset($surveyAns->c5) ? $surveyAns->c5 : $student->fcontactno}}">
                                    </div>
                              </div>
                              <p class="bg-danger p-2">Mother</p>
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C6. Mother's Full Name (surname, full name, middle name): </label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C7. Mother's Highest Educational Attainment: </label>
                                    ...
                                    <div class="col-sm-8">
                                          <select name="c8" id="c8" class="form-control">
                                                ...
                                                <option value="3" @if($surveyAns->c8 == 3) selected @endif>College graduate</option>
                                                <option value="4" @if($surveyAns->c8== 4) selected @endif>Vocational</option>
                                                <option value="5" @if($surveyAns->c8 == 5) selected @endif>Master’s/Doctorate degree</option>
                                                <option value="6" @if($surveyAns->c8 == 6) selected @endif>Did not attend school</option>
                                          </select>
                                    </div>
                                   
                              </div>
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C8. Mother's Employment Status: </label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C9. Working from home due to ECQ? </label>
                                    <div class="col-sm-8 pt-2">
                                          <div class="icheck-primary d-inline">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C10. Mother's Contact number/s (cellphone/ telephone): </label>
                                    <div class="col-sm-8">
                                          <input class="form-control" id="c11" name="c11" placeholder="Mother's Contact number/s (cellphone/ telephone)" value="{{isset($surveyAns->c11) ? $surveyAns->c11 : $student->mcontactno}}">
                                    </div>
                              </div>
                              <p class="bg-danger p-2">Guardian</p>
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C11. Guardian's Full Name (surname, full name, middle name): </label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C12. Guardian's Highest Educational Attainment: </label>
                                    <div class="col-sm-8">
                                          <select name="c14" id="c14" class="form-control">
                                                ...
                                                <option value="3" @if($surveyAns->c14 == 3) selected @endif>College graduate</option>
                                                <option value="4" @if($surveyAns->c14 == 4) selected @endif>Vocational</option>
                                                <option value="5" @if($surveyAns->c14 == 5) selected @endif>Master’s/Doctorate degree</option>
                                                <option value="6" @if($surveyAns->c14 == 6) selected @endif>Did not attend school</option>
                                          </select>
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C13. Guardian's Employment Status: </label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C14. Working from home due to ECQ? </label>
                                    <div class="col-sm-8 pt-2">
                                          <div class="icheck-primary d-inline">
                              ...
                              <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label ">C15. Guardian's Contact number/s (cellphone/ telephone): </label>
                                    <div class="col-sm-8">
                                          <input class="form-control" id="C17" name="c17" placeholder="Guardian's Contact number/s (cellphone/ telephone)" value="{{isset($surveyAns->c17) ? $surveyAns->c17 : $student->gcontactno}}">
                                    </div>
                              </div>
                              ...
                              <div class="form-group row border-top">
                                    ...
                                    <div class="col-sm-8 pt-2">
                                          <div class="row">
                                                <div class="col-md-6">
                                                      <div class="icheck-primary d-inline">
                                                            <input type="checkbox" id="d7a" name="d7[]" value="1" @if(collect(explode(" ",$surveyAns->d7))->contains('1')) checked="checked" @endif class="d7_input">
                                                            <label for="d7a">online learning</label>
                                                      </div>
                                                </div>
                                                <div class="col-md-6">
                                                      <div class="icheck-primary d-inline">
                                                            <input type="checkbox" id="d7b" name="d7[]" value="2" @if(collect(explode(" ",$surveyAns->d7))->contains('2')) checked="checked" @endif class="d7_input">
                                                            <label for="d7b">television</label>
                                                      </div>
                                                </div>
                                                <div class="col-md-6">
                                                      <div class="icheck-primary d-inline">
                                                            <input type="checkbox" id="d7c" name="d7[]" value="3" @if(collect(explode(" ",$surveyAns->d7))->contains('3')) checked="checked" @endif class="d7_input">
                                                            <label for="d7c">radio</label>
                                                      </div>
                                                </div>
                                                <div class="col-md-6">
                                                      <div class="icheck-primary d-inline">
                                                            <input type="checkbox" id="d7d" name="d7[]" value="4" @if(collect(explode(" ",$surveyAns->d7))->contains('4')) checked="checked" @endif class="d7_input">
                                                            <label for="d7d">modular learning</label>
                                                      </div>
                                                </div>
                                                <div class="col-md-6">
                                                      <div class="icheck-primary d-inline">
                                                            <input type="checkbox" id="d7e" name="d7[]" value="5" @if(collect(explode(" ",$surveyAns->d7))->contains('5')) checked="checked" @endif class="d7_input">
                  ...
                  <input hidden name="studid" value="{{$student->id}}">
                  <input hidden name="syid" id="syid" >
                  </form>
