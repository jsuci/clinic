                  ...
                  <div class="col-12">
                        <div class="card">
                              <div class="card-header bg-info ">
                                    <span class="text-white h4"><b>Sync Modules Setup ( Local to Cloud )</b></span>
      ...
      <section class="content pt-0">
            <div class="row">
                  <div class="col-12">
                        <div class="card">
                              <div class="card-header bg-info ">
                                    <span class="text-white h4"><b>Enabled Modules</b></span>
                                    {{-- <input type="text" id="search" name="search" class="form-control form-control-sm float-right w-25" placeholder="Search" > --}}
                              </div>
                              <div class="card-body table-responsive p-0" 
                              ...
                              <div class="card-footer">
                                    <div class="" id="data-container-enabled">
                                    </div>
                              </div> 
                        </div>
                  </div>
      ...
      <script>
            $(document).ready(function(){
                  ...
                  function processpaginate(skip = null,take = null ,search = null, firstload = true){
                        ...
                        $.ajax({
                              type:'GET',
                              url:'/syncmodules?table=table&synctype=ltc&take='+take+'&skip='+skip+'&table=table'+'&search='+search,
                  ...
                  function processpaginateenabled(skip = null,take = null ,search = null, firstload = true){
                        ...
                        $.ajax({
                              type:'GET',
                              url:'/syncmodules?table=table&enabled=enabled&synctype=ltc&take='+take+'&skip='+skip+'&table=table'+'&search='+search,
                              success:function(data) {
                  ...
                  function paginationenabled(itemCount,pagetype){
                        ...
                        $('#data-container-enabled').pagination({
                              dataSource: result,
                              hideWhenLessThanOnePage: true,
                              pageNumber: pageNum,
                              pageRange: 1,
                  ...
                  $(document).on('click','input[type="checkbox"]',function(){
                        ...
                        $.ajax({
                              type:'GET',
                              url:'syncmodules?update=update&type='+$(this).attr('data-value')+'&tablename='+$(this).attr('data-table')+'&status='+status+'&synctype=ltc',
                              success:function(data) {
                                    processpaginateenabled(0,10,null,true)
