...
@section('footerjavascript')
      ...
      <script>
            $(document).ready(function(){
                  ...
                  $(document).on('click','#fix_credentials',function(){

                        $.ajax({
                              type:'GET',
                              url:'/nocrestudents?fix=fix&firstname='+$(this).attr('data-fname')+'&lastname='+$(this).attr('data-lname')+'&id='+$(this).attr('data-id')+'&sid='+$(this).attr('data-sid'),
                              success:function(data) {
                  ...
                  function processpaginate(skip = null,take = null ,search = null, firstload = true){
                        ...
                        $.ajax({
                              type:'GET',
                              url:'/nocrestudents?take='+take+'&skip='+skip+'&table=table'+'&search='+search+'&facultynstaff=facultynstaff',
                              success:function(data) {
