		...
		<div class="col-lg-12">
			<div class="main-card mb-3 card">
				<div class="card-body bg-info">	
					<div class="row">
						<div class="col-md-6">
							<button id="btnstudpaid" class="btn btn-warning">Students ready to enroll <span id="" class="badge badge-primary studpaid">0</span></button>
						</div>
						<div class="input-group mb-1 float-right col-md-6">
				...
				<div class="card-body">
					<div class="table-responsive">
						...
						<table id="example2" class="table table-striped table-sm" role="grid" aria-describedby="example2_info">
