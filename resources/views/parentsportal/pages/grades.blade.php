            ...
            <div class="col-lg-6">
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 165px; overflow-y: scroll">
                            <table class="table table-head-fixed table-sm">
                                <thead>
                                    <tr>
                                        <th width=25% class="align-middle h6"><small><b>Month</b></small></th>
                                        <th width=25% class="align-middle h6"><small><b>School Days</b></small></th>
                                        <th width=25% class="align-middle h6"><small><b>Days Present</b></small></th>
                                        <th width=25% class="align-middle h6"><small><b>Days Absent</b></small></th>
                                    </tr>
                                </thead>
                                <tbody>
