...
<html>
    ...
    <body>
        ...
        @endphp
        <div style="width: 100%;font-weight: bold; font-size: 15px; text-align: center; font-weight: bold;">{{DB::table('schoolinfo')->first()->schoolname}}</div>
        <div style="width: 100%;font-size: 13px; text-align: center;">{{DB::table('schoolinfo')->first()->address}}</div>
