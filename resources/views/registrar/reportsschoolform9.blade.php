                                ...
                                <div class="row">
                                    ...
                                    {{-- {{collect($section)}} --}}
                                        @if($section->gradelevelid == $gradelevel->gradelevelid)
                                            <div class="col-md-4">
                                                <form action="/reports_schoolform9/preview/{{$schoolyear}}/{{$section->sectionid}}/{{$gradelevel->gradelevelid}}" method="get">
                                                    <a>
                                                        <div class="info-box">
                                                            ...
                                                            <div class="info-box-content">
                                                                ...
                                                                <span class="info-box-number">
                                                                    ...
                                                                    @if($section->teacher_lastname == null && $section->teacher_firstname == null)

                                                                        <small>No Class Adviser  assigned</small>
                                ...
                                <div class="row">
                                    @foreach ($grade_sections_higher as $sectionHigher)
                                        @if($sectionHigher->gradelevelid == $gradelevelHigh->gradelevelid)
                                            <div class="col-md-4">
                                                <form action="/reports_schoolform9/preview/{{$schoolyear}}/{{$sectionHigher->sectionid}}/{{$gradelevelHigh->gradelevelid}}" method="get">
                                                    <a>
                                                        <div class="info-box">
                                                            <span class="info-box-icon bg-info elevation-1">
                                                                <i class="fa fa-door-open"></i>
