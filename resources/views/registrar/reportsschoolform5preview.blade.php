        ...
        <div class="col-12">
            <div class="card card-default color-palette-box">
                <div class="card-header">
                    ...
                    <br>
                    <small><em>Revised to confom with the instructions of Deped Order 8, s. 2015</em></u></small>
                    @if(isset($gradelevelid))
                        ...
                        @if($schoolinfo->authorized == null)
                            <a href="#"  class="btn btn-success btn-sm text-white float-right authorizedinput" route="/reports_schoolform5/print/{{$selectedform}}/{{$schoolyear ?? ''}}/{{$sectionid}}/{{$gradelevelid}}" viewtarget="pdf">
                                <i class="fa fa-upload"></i>
                                Print
                            </a>
                        @else
                            <a href="/reports_schoolform5/print/{{$selectedform}}/{{$schoolyear ?? ''}}/{{$sectionid}}/{{$gradelevelid}}" target="_blank" class="btn btn-success btn-sm text-white float-right">
                                <i class="fa fa-upload"></i>
                                Print
                            </a>
                        @endif
                                        ...
                                        @foreach ($students as $student)
                                            @if(strtoupper($student[1]->gender)=="MALE")
                                                <tr>
                                                    <td>{{$student[1]->lrn}}</td>
                                                    <td>
                                                        {{$student[1]->lastname}}, {{$student[1]->firstname}} 
                                                        @if($student[1]->middlename != null)
                                                        {{$student[1]->middlename[0]}}. 
                                                        @endif
                                                        {{$student[1]->suffix}} 
                                                    </td>
                                                    <td>
