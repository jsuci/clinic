...
@section('content')
    ...
    <div class="row">
        &nbsp;
        <div class="col-md-12">
            <form action="/elementary/dashboard" method="GET">
                @csrf
        ...
        <div class="col-md-12">
            ...
            <form action="/elem/editform10/savechanges" method="GET">
                @csrf
                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="container">
                                ...
                                <tbody>
                                    ...
                                    @foreach($grades as $grade)
                                        <tr>
                                            ...
                                            <td class="tdInputClass">
                                                <input type="text" class="form-control" name="old{{$old}}[]" value="{{$grade->credits}}"/>
                                            </td>
                                            <td></td>
                                        </tr>
                                        @php
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label>TOTAL NUMBER OF UNITS EARNED</label>
                                    <input type="number" name="numUnits" class="form-control form-control-sm" value="{{$schoolinfo[0]->unitsearned}}"/>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-3">
                                    <label>TOTAL NUMBER OF YEARS IN SCHOOL TO DATE</label>
                                    <input type="number" name="numYears" class="form-control form-control-sm" value="{{$schoolinfo[0]->yearsinschool}}"/>
                                </div>
                            </div>
                        </div>
                        &nbsp;
