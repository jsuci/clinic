    ...
    <body>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="wudth: 70%; text-align: center;">
                        ...
                        <div style="width: 100%; font-weight: bold; font-size: 15px !important; line-height: 5px;">&nbsp;</div>
                        <div style="width: 100%; font-weight: bold; font-size: 15px !important;">Promotional Report</div>
        ...
        <main>
            ...
            @if(count($chunkstudents)>0)
                @foreach($chunkstudents as $keystud=>$students)
                    @if(count($students)>0)
                        <table style="width: 100%; font-size: 10.5px; @if(($keystud+1) < count($chunkstudents))page-break-after: always @endif" border="1">
                            <thead>
                                <tr>
                                    <th style="width: 2%; border-right: none !important;" rowspan="2">No.</th>
                                    <th style="width: 13%; border-right: none !important; border-left: none !important;" rowspan="2">Name<br/>(Surname, FIrst Name, Middle Name)<br/>in Alphabetical Order</th>
                                    <th style="width: 2%; border-right: none !important; border-left: none !important;" rowspan="2">Sex</th>
                                    <th style="width: 7%; border-right: none !important; border-left: none !important;" rowspan="2">Course</th>
                                    {{-- <th style="width: 2%;">Y<br/>E<br/>A<br/>R</th> --}}
                                    ...
                                    {{-- <th style="width: 2%; font-size: 8px;">U<br/>n<br/>i<br/>t<br/>s</th> --}}
                                    @endfor
                                    <th style="width: 5%; font-size: 8px;" rowspan="2">Total Units</th>
                                </tr>
                            ...
                            @foreach($students as $key=>$student)
                                ...
                                <tr nobr="true">
                                    ...
                                    @for($x = 0; $x < $maxsubjects; $x++)
                                        {{-- <td style=" font-size: 8px;">@if(isset($student->subjects[$x])) {{$student->subjects[$x]->subjcode}} @endif</td> --}}
                                        <td style="font-size: 10px !important;" colspan="2">@if(isset($student->subjects[$x])) {{$student->subjects[$x]->subjcode ?? $student->subjects[$x]->subjectcode}} @else &nbsp; @endif</td>
                                    @endfor
