            ...
            <div class="col-md-12">
                  <div class="card shadow" style="">
                        <div class="card-body">
                              ...
                              <div class="row">
                                   <div class="col-md-12">
                                         <button class="btn btn-primary btn-sm" id="button_to_modal_strand">Create strand</button>
                                   </div>
                              </div>
                              <div class="row mt-2">
                                    <div class="col-md-12"  style="font-size:.7rem">
                                          <table class="table-hover table table-striped table-sm table-bordered table-head-fixed nowrap display compact" id="strand_datatable" width="100%" >
                                                <thead>
                                                      <tr>
                                                            <th width="8%" >Code</th>
