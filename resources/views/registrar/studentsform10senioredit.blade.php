...
@section('content')
    ...
    <div class="row">
        &nbsp;
        <div class="col-md-12">
            <form action="/seniorhigh/dashboard" method="GET">
                @csrf
        ...
        <div class="col-md-12">
            ...
            <form action="/senior/editform10/savechanges" method="GET">
                @csrf
                            ...
                            @if(count($schoolinfo) == 0)
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <br>
                                        <input type="text" class="form-control form-control-sm" name="schoolid" value=""/>
                                    </div>
                                    <div class="col-md-5">
                                        <label>
                                        ...
                                        <br>
                                        <input type="text" class="form-control form-control-sm" name="schoolname" value=""/>
                                    </div>
                                    <div class="col-md-5">
                                        <label>
                                        ...
                                        <br>
                                        <input type="text" class="form-control form-control-sm" name="schooladdress" value=""/>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <br>
                                        <input type="text" class="form-control form-control-sm" name="section" value=""/>
                                    </div>
                                    <div class="col-md-4">
                                        <label>
                                        ...
                                        <br>
                                        <input type="text" class="form-control form-control-sm" name="adviser" value=""/>
                                    </div>
                                </div>
                            @else
                                <div class="row">
                                    ...
                                    @foreach($grades as $grade)
                                        ...
                                        <tr>
                                            <td class="tdInputClass">
                                                ...
                                                <input type="text" class="form-control" name="old{{$old}}[]" value="{{$grade->core}}"/>
                                            </td>
                                            <td class="tdInputClass">
