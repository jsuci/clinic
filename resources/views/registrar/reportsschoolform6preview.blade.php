...
@section('content')
    <style>
        .summaryTable th, .summaryTable td      { font-size: 11px; border:1px solid black !important; text-align: center; /* table-layout: fixed; */ padding: 3px; }
            ...
            <div class="card card-default color-palette-box">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        <strong>School Form 6 (SF6) Summarized Report on Promotion and Level of Proficiency</strong>
                    </h3>
                    <br>
                    <small><em>This replaces Form 20</em></small>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <form action="" method="get" name="formsubmit">
                            ...
                            <input type="hidden" name="formschoolhead" />
                            <input type="hidden" name="formdivrep" />
                            <input type="hidden" name="formdivsup"/>
                        </form>
    ...
    <script>
        $(document).on('change','select[name="selectedschoolyear"]', function (){
            ...
            $('form[name="formsubmit"]').attr('action','/reports_schoolform6/changeschoolyear');
            $('form[name="formsubmit"]').attr('target','');
            $('form[name="formsubmit"]').submit();
        });
        $(document).on('click','.btnprint', function (){
            $('input[name="formschoolhead"]').val($('input[name="schoolhead"]').val());
            $('input[name="formdivrep"]').val($('input[name="divrep"]').val());
            $('input[name="formdivsup"]').val($('input[name="divsup"]').val());
            $('form[name="formsubmit"]').attr('action','/reports_schoolform6/print');
