                ...
                <tr>
                    <td width="50%">
                        <table class="table " style="width:95% !important">
                            <tr>
                                <td colspan="13"><center>REPORT ON ATTENDANE</center></td>
                            </tr>
    ...
    <table class="table" >
            <tr>
                ...
                <td width="50%" >
                        ...
                        @foreach (collect($grades)->where('semid',1) as $item)
                            ...
                            <tr class="table-bordered">
                                ...
                                @if($item->q1 != null && $item->q2 != null)
                                    <td class="text-center p-0 align-middle" style="font-size:13px !important">{{number_format( ($item->q1+$item->q2) / 2 )}}</td>
                                @else
                                    <td class="text-center p-0 align-middle" style="font-size:13px !important"></td>
                                @endif
                    ...
                    @if( count($grades) != 0)
                        @php
                            $genaverage = (collect($grades)->avg('q1') + collect($grades)->avg('q2') ) / 2 ;
                        @endphp
                    @else
                        @php
                            $genaverage = null;    
                    ...
                    @endif
                        ...
                        <tr class="table-bordered genave">
                                ...
                                @if(collect($grades)->where('semid',1)->where('q1',null)->count() == 0)
                                    <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">{{round(collect($grades)->where('semid',1)->avg('q1'))}}</td>
                                @else
                                    <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">&nbsp;</td>
                                @endif

                                @if(collect($grades)->where('semid',1)->where('q2',null)->count() == 0)
                                    <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">{{round(collect($grades)->where('semid',1)->avg('q2'))}}</td>
                                @else
                                    <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">&nbsp;</td>
                                @endif
                            
                                
                                @if( collect($grades)->where('semid',1)->where('q1',null)->count() == 0 && collect($grades)->where('semid',1)->where('q2',null)->count() == 0 )
                        ...
                        @if( count($grades) != 0 && collect($grades)->where('semid',2)->count() > 0)
                            @php
                                $genaverage =  (collect($grades)->where('semid',2)->avg('q1') + collect($grades)->where('semid',2)->avg('q2') ) / 2  ;
                            @endphp
                        @else
                            @php
                                $genaverage = null;    
                        ...
                        @endif
                            ...
                            <tr class="table-bordered genave">
                                    ...
                                    @if(collect($grades)->where('semid',2)->where('q1',null)->count() == 0)
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">{{round(collect($grades)->where('semid',2)->avg('q1'))}}</td>
                                    @else
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">&nbsp;</td>
                                    @endif

                                    @if(collect($grades)->where('semid',2)->where('q2',null)->count() == 0)
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">{{round(collect($grades)->where('semid',2)->avg('q2'))}}</td>
                                    @else
                                        <td class="text-center p-1" style="font-family: Arial, Helvetica, sans-serif; font-size:13px !important;">&nbsp;</td>
                                    @endif
                                
                                    
                                    @if( collect($grades)->where('semid',2)->where('q1',null)->count() == 0 && collect($grades)->where('semid',2)->where('q2',null)->count() == 0 )
