...
@else
    ...
    <table style="width: 100%" id="table1">
        <tr>
            ...
            <td style="text-align:center; font-size: 11px;">Republic of the Philippines</td>
            @if(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'mci')
            <td width="15%" style="text-align:right;"  @if(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'hc babak') rowspan="6" @else rowspan="5" @endif><img src="{{base_path()}}/public/assets/images/deped_logo.png" alt="school" width="80px"></td>
            @else
                ...
                <table style="width: 100%; font-size: 11px; border: 1px solid black; border-bottom: none;">
                    ...
                    <tr>
                        ...
                        <td colspan="5" style="text-align: justify;">
                            <p style="text-align: justify;">I CERTIFY that this is a true record of <u>{{$studinfo->lastname}}, {{$studinfo->firstname}} {{$studinfo->middlename[0]}}. {{$studinfo->suffix}}</u> with LRN <u>{{$studinfo->lrn}}</u> and  that he/she is  eligible for admission to Grade <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>.</p>
                        </td>
                        <td style="width: 3%;">&nbsp;</td>
                    </tr>
                    <tr>
                ...
                @else
                    <table style="width: 100%; font-size: 11px; border: 1px solid black;">
                        ...
                        <tr>
                            <td style="width: 3%;"></td>
                            <td colspan="5" style="text-align: justify;">
                                I CERTIFY that this is a true record of <u>{{$studinfo->lastname}}, {{$studinfo->firstname}} {{$studinfo->middlename[0] ?? null}}. {{$studinfo->suffix}}</u> with LRN <u>{{$studinfo->lrn}}</u>
                            </td>
                            <td style="width: 3%;"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td style="width: 20%; border-bottom: 1px solid black; text-aligsn: center;">{{strtoupper(DB::table('schoolinfo')->first()->authorized)}}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td></td>
