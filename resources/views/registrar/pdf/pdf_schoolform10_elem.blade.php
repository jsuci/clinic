...
{{-- @if(strtolower(DB::table('schoolinfo')->first()->schoolid) == '405308') --}}
    <table style="width: 100%" id="table1">
        <tr>
            <td width="5%" style="text-align: left;"><sup style="font-size: 9px;">SF10-ES</sup></td>
                                ...
                                @if($record[0]->type == 1)
                                    ...
                                    @else
                                        <tr style="font-weight: bold;">
                                            ...
                                            <td>{{number_format(collect($record[0]->grades)->where('inMAPEH','0')->sum('finalrating')/collect($record[0]->grades)->where('inMAPEH','0')->count()) >= 75 ? 'PASSED':'FAILED'}}</td>
                                        </tr>
                                    @endif
