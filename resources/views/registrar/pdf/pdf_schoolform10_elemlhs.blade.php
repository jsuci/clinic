            ...
            @if(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'bct')
                <table style="width: 100%; font-size: 11px; border: 1px solid black;">
                    ...
                    <tr>
                        <td style="width: 3%;"></td>
                        <td colspan="5" style="text-align: justify;">
                            I CERTIFY that this is a true record of <u>{{$studinfo->lastname}}, {{$studinfo->firstname}} @if($studinfo->middlename != null){{$studinfo->middlename[0]}}.@endif {{$studinfo->suffix}}</u> with LRN <u>{{$studinfo->lrn}}</u>
                        </td>
                        <td style="width: 3%;"></td>
                    </tr>
                    <tr>
