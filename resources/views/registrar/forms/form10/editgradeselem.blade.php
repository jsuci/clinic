                    ...
                    @foreach($grades as $grade)
                        @if(strtolower($grade->subjectname) != 'general average')
                            <tr>
                                ...
                                <td><input type="text" id="q1{{$grade->id}}" value="{{$grade->q1}}" class="form-control"/></td>
                                <td><input type="text" id="q2{{$grade->id}}" value="{{$grade->q2}}" class="form-control"/></td>
                                <td><input type="text" id="q3{{$grade->id}}" value="{{$grade->q3}}" class="form-control"/></td>
                                <td><input type="text" id="q4{{$grade->id}}" value="{{$grade->q4}}" class="form-control"/></td>
                                <td><input type="text" id="finalrating{{$grade->id}}" value="{{$grade->finalrating}}" class="form-control"/></td>
                                <td><input type="text" id="remarks{{$grade->id}}" value="{{$grade->remarks}}" class="form-control"/></td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-warning p-1 btn-edit-editsubject" data-id="{{$grade->id}}"><i class="fa fa-edit"></i> Update</button>
                                    <button type="button" class="btn btn-sm btn-default p-1 btn-edit-deletesubject" data-id="{{$grade->id}}"><i class="fa fa-trash text-danger"></i>&nbsp;</button><br/>
