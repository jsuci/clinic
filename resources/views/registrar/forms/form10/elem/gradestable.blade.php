                ...
                @if(collect($records)->where('levelid', $gradelevel->id)->count() == 0)
                    ...
                    <div class="card-body p-0 pr-1 pl-1">
                        <div class="row">
                            <div class="col-md-12">
                                {{-- @php
                                    $defaultsubjects = collect($subjects)->values();
                                @endphp --}}
                                        ...
                                        {{-- @if(count($defaultsubjects)>0)
                                            @foreach($defaultsubjects as $defaultsubject)
                                                <tr>
                                                    ...
                                                    <td style="width: 30%;"><input type="text" class="form-control form-control-sm p-0 input-norecord new-input input-subjdesc" placeholder="Subject" value="{{ucwords(strtolower($defaultsubject->subjdesc))}}"/></td>
                                                    ...
                                                    <td style="width: 15%;"><input type="number" class="form-control form-control-sm p-0 input-norecord new-input input-finalgrade" placeholder="Final"/></td>
