    ...
    <div class="card-body p-1">
        <div class="row">
            ...
            <div class="col-md-12 table-responsive" style="height: 500px;">
                <table class="table table-bordered table-head-fixed" style="font-size: 12px;">
                    ...
                    <tbody>
                        ...
                        @foreach(collect($students)->where('gender','male')->values() as $key => $eachstudent)
                            <tr class="eachstudent" id="{{$eachstudent->id}}">
                                ...
                                <td class="text-center">@if($eachstudent->completed == 1)Y @elseif($eachstudent->completed == 0)N @endif
                                </td>
                                <td class="text-center">
                                    {{$eachstudent->certificationlevel}}
                                </td>
