...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">School Form 9</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            @if($acadprogid == 5)
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <label>&nbsp;</label><br/>
                        <button type="button" class="btn btn-primary" id="btn-getstudents"><i class="fa fa-sync"></i> Get Students</button>
                    </div>
                </div>
            @else
                <div class="row mb-2">
    ...
    <script>
        ...
        $(document).ready(function(){
            $('#btn-getstudents').on('click', function(){
