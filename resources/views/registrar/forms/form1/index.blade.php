    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.btn-exportpdf', function(){
                ...
                window.open("/registrar/forms/schoolform1/export?schoolyear="+syid+"&semid="+semid+"&sectionid="+sectionid+"&levelid="+levelid+"&exporttype=pdf");
            })
            $(document).on('click','.btn-exportexcel', function(){
                ...
                window.open("/registrar/forms/schoolform1/export?schoolyear="+syid+"&semid="+semid+"&sectionid="+sectionid+"&levelid="+levelid+"&exporttype=excel");
            })
        })
    </script>
@endsection
