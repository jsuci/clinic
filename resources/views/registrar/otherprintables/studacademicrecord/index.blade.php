...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">STUDENT ACADEMIC RECORD</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/home">Home</a></li>
                        <li class="breadcrumb-item active">STUDENT ACADEMIC RECORD</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
    ...
    <script>
        ...
        $('#btn-generate').on('click', function(){
            ...
            $.ajax({
                url: '/printable/studentacademicrecord',
                type:'GET',
                // dataType: 'json',
                data: {
                    action: 'generate',
        ...
        $(document).ready(function(){
            $(document).on('click','#btn-export', function(){
                ...
                var registrar = null;
                window.open("/printable/studentacademicrecord?studid="+studid+"&action=export&registrar="+registrar,'_blank');
            })
        })
    </script>
@endsection
