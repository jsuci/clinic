...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Certificate of Graduation</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/home">Home</a></li>
                        <li class="breadcrumb-item active">Certificate of Graduation</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
            ...
            <div class="row mb-2"> --}}
                <div class="col-md-4">
                    ...
                    <select class="form-control" id="select-template">
                        <option value="0">for Non-Accredited Courses</option>
                        <option value="1">for Accredited Courses</option>
                    </select>
                </div>
                {{-- <div class="col-md-3">
    ...
    <script>
        ...
        $('#btn-generate').on('click', function(){
            ...
            $.ajax({
                url: '/printable/certification/certofgraduation',
                type:'GET',
                // dataType: 'json',
                data: {
                    action:'filter',
