                        ...
                        <form id="regForm" action="/insertSubject" method="GET">
                            ...
                            <div class="modal-header si bg-info">
                                ...
                                <div class="form-group">
                                    <label>Subject</label>
                                    <input value="{{old('sn')}}" class="form-control @error('sn') is-invalid @enderror" id="sn"  name="sn" placeholder="Subject Name" onkeyup="this.value = this.value.toUpperCase();">
                                    @if($errors->has('sn'))
                            ...
                            <div class="tab">
                                ...
                                <br>
                                <p class="text-primary">Select grade level to apply subject grade setup. <u>You can select multiple grade level.</u></p>
                                <div class="form-group">
                            ...
                            <div class="modal-header bg-info sgs">
                                ...
                                <br>
                                <button type="button" class="btn btn-danger"  onclick="nextPrev(-1)" >Previous</button>
                                <button type="submit" class="btn btn-success proceed" >Proceed</button>
                            </div>
            ...
            @endif
                ...
                {{-- <div class="row"> --}}
                    ...
                    {{-- <div class="col-md-4"> --}}
                        ...
                        @if(Crypt::decrypt($acadid)==5 && auth()->user()->type == 2)
                        ...
                        @elseif(Crypt::decrypt($acadid)!=5 && auth()->user()->type == 2)
