    ...
    * {
    ...
    <table class="header">
        <tr>
            ...
            <td style="text-align:right;"><strong>Retention Report</strong></strong><br><small>S.Y  <strong>{{$sy->sydesc}}</strong></small></td>
        </tr>
    </table>
    <br>
        ...
        <tbody>
            @foreach($repeaters as $repeater)
                {{-- @if(strtolower($enrolledstud->gender) == "female") --}}
                    ...
                    @endphp
                    <tr>
                        <td>{{$totalnumberofstudents}} {{$repeater->firstname}} {{$repeater->middlename[0].'.'}} {{$repeater->lastname}} {{$repeater->suffix}}</td>
