                                ...
                                <div class="row">
                                    @foreach ($grade_sections_lower as $section)
                                        @if($section->gradelevelid == $gradelevel->gradelevelid)
                                            <div class="col-md-3">
                                                <form action="/reports_schoolform6/preview/{{$schoolyear}}/{{$section->sectionid}}/{{$gradelevel->gradelevelid}}/{{$section->teacherid}}" method="get">
                                                    <a>
                                                        <div class="info-box">
                                ...
                                <div class="row">
                                    @foreach ($grade_sections_higher as $sectionHigher)
                                        @if($sectionHigher->gradelevelid == $gradelevelHigh->gradelevelid)
                                            <div class="col-md-3">
                                                <form action="/reports_schoolform6/preview/{{$schoolyear}}/{{$sectionHigher->sectionid}}/{{$gradelevelHigh->gradelevelid}}/{{$sectionHigher->teacherid}}" method="get">
                                                    <a>
                                                        <div class="info-box">
                                                            <span class="info-box-icon bg-info elevation-1">
                                                                @php
