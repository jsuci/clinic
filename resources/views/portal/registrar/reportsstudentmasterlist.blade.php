                                ...
                                <div class="row">
                                    ...
                                    @foreach ($grade_sections_lower as $section)
                                        @if($section->gradelevelid == $gradelevel->gradelevelid)
                                            <div class="col-md-3">
                                                <form action="/reports_studentmasterlist/preview/{{$schoolyear}}/{{$section->sectionid}}" method="get">
                                                    <a>
                                                        <div class="info-box">
                                ...
                                <div class="row">
                                    @foreach ($grade_sections_higher as $sectionHigher)
                                        @if($sectionHigher->gradelevelid == $gradelevelHigh->gradelevelid)
                                            <div class="col-md-3">
                                                <form action="/reports_studentmasterlist/preview/{{$schoolyear}}/{{$sectionHigher->sectionid}}" method="get">
                                                    <a>
                                                        <div class="info-box">
                                                            <span class="info-box-icon bg-info elevation-1">
                                                                @php
