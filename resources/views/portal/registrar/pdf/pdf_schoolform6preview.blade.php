...
<table id="header">
    <tr>
        <th rowspan="3" style="width:10%;" class="leftImg">
            <center>
                <img style="padding:0px; margin:0px;" src="{{base_path()}}/public/assets/images/department_of_Education.png" alt="school" width="80px">
            </center>
        </th>
        <td colspan="8" style="padding-top:0px;">
            <div style="padding-right:7%;margin-top: 0px;padding-top:0px;">
                <center>
                    <h3 style="font-size:20px !important;">School Form 6 (SF6)<br>Summarized Report on Promotion and Level of Proficiency</h3>
                    <sup>
    ...
    <tr>
        ...
        <td>
            ...
            @foreach ($finalGrades as $student)
                @if(($student[1]->gender)=="MALE")
                    @if(($student[1]->levelid)==$grade_1[0]->id)
                        @if($student[0]->Final>=75 && $student[0]->Final<=79)
                            @php
                            $dMale1+=1
                            @endphp
                        @endif
    ...
    <tr>
        ...
        <td>
            ...
            @foreach ($finalGrades as $student)
                @if(($student[1]->gender)=="MALE")
                    @if(($student[1]->levelid)==$grade_1[0]->id)
                        @if($student[0]->Final>=80 && $student[0]->Final<=84)
                            @php
                            $apMale1+=1
                            @endphp
                        @endif
    ...
    <tr>
        ...
        <td>
            ...
            @foreach ($finalGrades as $student)
                @if(($student[1]->gender)=="MALE")
                    @if(($student[1]->levelid)==$grade_1[0]->id)
                        @if($student[0]->Final>=85 && $student[0]->Final<=89)
                            @php
                            $pMale1+=1
                            @endphp
                        @endif
...
<table style="table-layout:fixed;width:100%;font-size:11px;">
    <tbody>
        <tr>
            ...
            <td style="padding:5px;border-bottom: 1px solid black;border-top:hidden;"><small></small></td>
            <th style="padding:5px;border:hidden;text-align:right;width:10%"><small>Noted by:</small></th>
            <td style="padding:5px;border-right:hidden;border-bottom: 1px solid black;border-top:hidden;"></td>
        </tr>
        <tr>
