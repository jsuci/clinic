            ...
            <div class="card card-default color-palette-box">
                <div class="card-header">
                    ...
                    @if(isset($gradelevelid))
                        <a href="/reports_schoolform5/print/{{$selectedform}}/{{$schoolyear ?? ''}}/{{$sectionid}}/{{$gradelevelid}}/{{$teacherid}}" target="_blank" class="btn btn-success btn-sm text-white float-right">
