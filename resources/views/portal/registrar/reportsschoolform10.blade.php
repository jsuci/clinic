                                ...
                                <div class="row">
                                    @foreach ($grade_sections_lower as $section)
                                        @if($section->gradelevelid == $gradelevel->gradelevelid)
                                            <div class="col-md-3">
                                                <form action="/reports_schoolform10/students/{{$schoolyear}}/{{$section->sectionid}}/{{$gradelevel->gradelevelid}}/{{$section->teacherid}}" method="get">
                                                    <a >
                                                    <div class="info-box">
                                                        <span class="info-box-icon bg-info elevation-1">
                                                            @php
                                                                $words = explode(" ", $section->sectionname);
                                                                $sectionname = "";
                                                                foreach ($words as $w) {
                                                                    $sectionname .= $w[0];
                                                                }
                                                        ...
                                                        <div class="info-box-content">
                                                            ...
                                                            <input type="hidden" value="School Form 10" id="selectedform" name="selectedform"/>
                                ...
                                <div class="row">
                                    @foreach ($grade_sections_higher as $sectionHigher)
                                        @if($sectionHigher->gradelevelid == $gradelevelHigh->gradelevelid)
                                            <div class="col-md-3">
                                                <form action="/reports_schoolform10/students/{{$schoolyear}}/{{$sectionHigher->sectionid}}/{{$gradelevelHigh->gradelevelid}}/{{$sectionHigher->teacherid}}" method="get">
                                                    <a >
                                                        <div class="info-box">
                                                            <span class="info-box-icon bg-info elevation-1">
                                                                @php
                                                                    $words = explode(" ", $sectionHigher->sectionname);
                                                                    $sectionname = "";
                                                                    foreach ($words as $w) {
                                                                        $sectionname .= $w[0];
                                                                    }
