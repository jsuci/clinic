            ...
            <div class="card card-default color-palette-box">
                <div class="card-header">
                    ...
                    @if(isset($gradelevelid))
                        <a href="/reports_schoolform6/print/{{$schoolyear}}/{{$sectionid}}/{{$gradelevelid}}/{{$teacherid}}" target="_blank" class="btn btn-primary btn-sm text-white float-right">
                    ...
                    @if(isset($students))
                        ...
                        <table class="table" style="border: 1px solid black !important;table-layout:fixed;">
                            <tr>
                                ...
                                <td style="padding:5px;border-bottom: 1px solid black;"><small></small></td>
                                <td style="padding:5px;border:hidden;text-align:right"><small>Noted by:</small></td>
                                <td style="padding:5px;border-right:hidden;border-bottom: 1px solid black;width:20%"></td>
                            </tr>
                            <tr>
