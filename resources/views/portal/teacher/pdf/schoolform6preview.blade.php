...
@endphp
    <table id="header">
        <tr>
            ...
            <td colspan="8" style="padding-top:0px;"><div style="padding-right:7%;margin-top: 0px;padding-top:0px;"><center><h3 style="font-size:20px !important;">School Form 6 (SF6)<br>Summarized Report on Promotion and Level of Proficiency</h3><sup><em>(This replaces Form 20)</em></sup></center><br></div></td>
        </tr>
        <tr>
