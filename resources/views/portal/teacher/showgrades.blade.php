                        ...
                        // }
                            ...
                            if(data[1].length == 0){
                                ...
                                $.each(data[0], function(key, value){
                                    ...
                                    for(var x = 0 ; x <= 9 ; x++){
                                        $('.wwhr'+x.toString()).each(function(){
                                            if($(this).text()=='0'){
                                                $(this).attr('class',''+('wwhr'+x.toString())+' bg-warning' );
                                            }
                                            else{
                                    ...
                                    for(var x = 0 ; x <= 9 ; x++){
                                        $('.pthr'+x.toString()).each(function(){
                                            if($(this).text()=='0'){
                                                $(this).attr('class',''+('pthr'+x.toString())+' bg-warning' );
                                            }
                                            else{
                                    ...
                                    $('.qahr1').each(function(){
                                        if($(this).text()=='0'){
                                            $(this).attr('class',''+'qahr1'+' bg-warning' );
                                        }
                                        else{
                                ...
                                $.each(data[1], function(key, value){
                                    ...
                                    $('#body').append(
                                        '<tr id="'+value.headerid+'" class="'+value.studid+'">'+
                                    ...
                                    for(var x = 0 ; x <= 9 ; x++){
                                        $('.ww'+x.toString()).each(function(){
                                            if($(this).text()=='0'){
                                                $(this).attr('class',''+('ww'+x.toString())+' bg-warning' );
                                            }
                                        })
                                    }
                                    // studentId+=1;
                ...
                success:function(data){
                    if(data.message == "Request sent!"){
                        ...
                        $('#messageContainer').append(
                            '<div class="alert alert-success alert-dismissible" id="messageContainer">'+
                                '<button type="button" class="close closeAlert" data-dismiss="alert" aria-hidden="true">×</button>'+
                    ...
                    if(data.message == "Request already exist!"){
                        $('#messageContainer').empty();
                        $('#messageContainer').append(
                            '<div class="alert alert-danger alert-dismissible" id="messageContainer">'+
                                '<button type="button" class="close closeAlert" data-dismiss="alert" aria-hidden="true">×</button>'+
                                '<h5><i class="icon fas fa-check"></i> Alert!</h5>'+
                                '<span>Request been sent! Please wait for a while...</span>'+
                            '</div>'
                        );
                    }
