                ...
                @if($employeebasicsalaryinfo->basistypeid == 4)
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <h5 class="text-right">{{number_format($employeebasicsalaryinfo->amount,2,'.',',')}}</h5>
                        </div>
                        <div class="col-md-2" >
                            <label>&nbsp;</label><br/>
                ...
                @elseif($employeebasicsalaryinfo->basistypeid == 6)
                    ...
                    <script>
                        ...
                        $('.scheddetails').on('click', function(){
                                ...
                                $.ajax({
                                    url: '/hr/employees/profile/tabbasicsalary/updatetimesched',
                                    type: 'GET',
                                    data: {
...
$(document).on('change','#selectbasis', function(){
    $.ajax({
        url: '/hr/employees/profile/tabbasicsalary/selectbasistype',
        type: 'GET',
        data: {
            typeid : $(this).val(),
            employeeid : '{{$profileinfoid}}'
...
$('#buttonsubmitnewrate').on('click', function(){
    ...
    if($('#formnewsalaryamount').val().replace(/^\s+|\s+$/g, "").length == 0){
        ...
        $.ajax({
            url: '/hr/employees/profile/tabbasicsalary/updaterate',
            type: 'GET',
            data: {
