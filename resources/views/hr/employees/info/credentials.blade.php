                                    ...
                                    <div id="addcredential{{$credential->id}}" class="modal custom-modal fade" role="dialog" style="display: none;" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <br>
                                                    <form action="/hr/employees/profile/tabcreds/upload" method="POST" enctype="multipart/form-data">
                                                        @csrf
...
<script>
    ...
    $(document).on('click','.credentialdelete', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '/hr/employees/profile/tabcreds/delete',
                    type:"GET",
                    dataType:"json",
                    data:{
                    ...
                    complete: function(){
                        ...
                        $('#custom-content-above-credentials-tab').click()
                    }
                })
            }
        })
