...
<script>
        ...
        $("input[name='deductionsetup']").unbind().click(function() {
            ...
            $.ajax({
                url: "/hr/updatedeductionsetuptype",
                type: "GET",
                data: {
                    employeeid:   '{{$profileinfoid}}',
                    setuptype  :   setuptype,
        ...
        $(document).on('click','.saveotherdeductionbutton', function(){
            ...
            {
                $.ajax({
                    url: "/hr/employeeotherdeductionsinfo",
                    type: "GET",
                    data: {
                        employeeid:   '{{$profileinfoid}}',
        ...
        $('.editotherdeductionbutton').unbind().click(function(){
            ...
            if(emptyelements == 0)
            {
                // console.log(amount)
                $.ajax({
                    url: "/hr/employeeotherdeductionsinfoedit",
                    type: "GET",
                    data: {
                        employeeid:   '{{$profileinfoid}}',
        ...
        $(document).on('click','.deletedotherdeduction', function(){
            ...
            $.ajax({
                url: "/hr/employeeotherdeductionsinfodelete",
                type: "GET",
                data: {
                    employeeid:   '{{$profileinfoid}}',
                    otherdeductionid:otherdeductionid
