...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
        <h4 class="text-warning" style="text-shadow: 1px 1px 1px #000000"><i class="fa fa-chart-line nav-icon"></i> Tardiness / Undertime</h4>
          <!-- <h1>Attendance</h1> -->
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/home">Home</a></li>
            <li class="breadcrumb-item active">Tardiness / Undertime</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
   ...
   $(function () {
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.btn-exporteachemp', function(){
            ...
            window.open('/hr/tardiness/generate?export=1&exportclass=1&employeeid='+employeeid+'&week='+$('#select-week').val(),'_blank');
        })
        $(document).on('click','#btn-exporttopdf', function(){
            var employeeid = $(this).attr('data-id');
            window.open('/hr/tardiness/generate?export=1&exportclass=2&week='+$('#select-week').val(),'_blank');
        })
    })
  </script>
@endsection
