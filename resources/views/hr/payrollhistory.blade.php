                        ...
                        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="/printpayrollhistory/{{Crypt::encrypt('bypayrollperiod')}}" method="get"  target="_blank" name="export">
                                        @foreach($getdaterange as $daterange)
            ...
            <tbody class="accordionitemtr text-uppercase" style="text-align: center;">
                @foreach($history as $historydetail)
                    <tr>
                        ...
                        <td>
                            <form action="/printpayrollhistory/{{Crypt::encrypt('individual')}}" target="_blank">
