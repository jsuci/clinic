                    ...
                    @foreach(collect($brackets)->sortByDesc('id') as $bracket)
                        <form action="/bracketedit" method="get">
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <input type="number" name="eescrate" step="any" class="form-control form-control-sm" value="{{$bracket->eescrate}}" disabled/>
                                    </div>
                                </td>
                                <td> 
                                    <div class="row">
                                        <input type="number" name="erscrate" step="any" class="form-control form-control-sm" value="{{$bracket->erscrate}}" disabled/>
                                    </div>
                                </td>
                                <td>
