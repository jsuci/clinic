...
@endphp
  <section class="content-header">
    ...
    <div class="card-deck">
      ...
      <div class="card shadow">
          <div class="card-header">
              <h2 class="card-title">Cashier Transactions</h2>
          </div>
          <div class="card-body">
            ...
            <div class="row mb-2">
              <div class="col-md-3">
                ...
                <select class="form-control" id="select-terminal">
              ...
              <div class="col-md-3">
                ...
                <select class="form-control" id="select-paymenttype">
                  <option value="0"></option>
                  @foreach($paymentoptions as $paymentoption)
                    <option value="{{$paymentoption->id}}">{{$paymentoption->description}}</option>
                  @endforeach
                </select>
              </div>
            </div>
            ...
            <div class="row mb-2">
                <div class="col-md-12 text-right"><button type="button" class="btn btn-primary" id="btn-gettransactions"><i class="fa fa-sync"></i> Generate</button></div>
            </div>
