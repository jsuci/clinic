...
@endphp
  <section class="content-header">
    ...
    <div class="card shadow">
      ...
      <div class="card shadow">
          <div class="card-header">
              <h2 class="card-title">Account Receivables</h2>
          </div>
          <div class="card-body">
            ...
            <div class="row mb-2"> --}}
                <div class="col-md-6 text-right align-self-end"><button type="button" class="btn btn-primary" id="btn-getaccountreceivables"><i class="fa fa-sync"></i> Generate</button></div>
            </div>
            <div id="container-accountreceivables-results">
...
<script src="{{asset('plugins/datatables-buttons/js/buttons.colVis.min.js')}}"></script>
  <script>
    $(document).ready(function(){
      ...
      $(document).on('click', '#btn-getaccountreceivables', function(){
          ...
          $.ajax({
              url: '{{$url->eslink}}/passData?action=getreceivables',
              type:'GET',
              datatype: 'json',
              data: {
                  datatype          :  'json',
              ...
              success:function(data) {
                ...
                //     <div class="row">
                //         <div class="col-md-12">
                //             <table class="table table-bordered" id="table-accountreceivables" style="font-size: 11px;">
                //                 <thead>
                //                     <tr>
                //                         <th>Date</th>
                //                         <th>OR No.</th>
                ...
                //                         <th class="text-right"><span class="text-bold accountreceivables-sum"></span></th>
                //                         <th></th>
                //                         <th></th>
                //                     </tr>`
                //                     if(data.length > 0)
                ...
                //   $('#container-accountreceivables-results').empty()
                //   $('#container-accountreceivables-results').append(displayCTransactions)
                //     $('.transactions-sum').text(totaltransactions.toFixed(2))

                //   $('#table-accountreceivables').DataTable({
                //       "paging": false,
                //       // "lengthChange": false,
                //       "searching": true,
                //       "ordering": false,
