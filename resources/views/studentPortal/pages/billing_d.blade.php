                        ...
                        <table class="table table-head-fixed" style="min-width:700px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td>Prelim</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[0]->amountdue,2)}}</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[0]->amountpay,2)}}</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[0]->balance,2)}}</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Midterm</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[1]->amountdue,2)}}</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[1]->amountpay,2)}}</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[1]->balance,2)}}</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Final</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[2]->amountdue,2)}}</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[2]->amountpay,2)}}</td>
                                    <td class="text-right">	&#8369; {{number_format($tuitions[2]->balance,2)}}</td>
                                </tr>
                                @if(count($collegebillings)>0)
                                    @foreach($collegebillings as $collegebilling)
                                        @if($collegebilling->duedate == null)
                                            <tr>
                                                <td colspan="2">{{$collegebilling->particulars}}</td>
                                                <td class="text-right">	&#8369; {{number_format($collegebilling->amountdue,2)}}</td>
                                                <td class="text-right">	&#8369; {{number_format($collegebilling->amountpay,2)}}</td>
                                                <td class="text-right">	&#8369; {{number_format($collegebilling->balance,2)}}</td>
                                            </tr>
                                        @endif
                                    @endforeach
                                @endif
