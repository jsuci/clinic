                                    ...
                                    <table class="mb-0 table table-bordered" style="min-width:330px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @if($generalave[0]->quarter1 != null && $generalave[0]->quarter1 >= 75)
                                                    <td class="p-2 align-middle text-center"><small>{{$generalave[0]->quarter1}}</small></td>
                                                @else
                                                    <td></td>
                                                @endif
                                                @if($generalave[0]->quarter2 != null && $generalave[0]->quarter2 >= 75)
                                                ...
                                                @if(Session::get('studentInfo')->acadprogid != 5 )
                                                    ...
                                                    @if($generalave[0]->quarter3 != null && $generalave[0]->quarter3 >= 75)
                                                        <td  class="p-2 align-middle text-center"><small>{{$generalave[0]->quarter3}}</<small></td>
                                                    @else
                                                        <td></td>
                                                    @endif

                                                    @if($generalave[0]->quarter4 != null && $generalave[0]->quarter4 >= 75)
                        ...
                        <div class="card mt-2">
                            ...
                            <table class="mb-0 table table-bordered" style="min-width:330px">
                                        ...
                                        <tbody>
                                            ...
                                            @endphp
                                            @foreach($grades as $temp_grades)
                                                @php
                                                    $genave += number_format( ( $temp_grades->q1 + $temp_grades->q2 ) / 2 );
                                                    
                                                @endphp
                                                <tr>
                                                    <td class="text-left align-middle"> {{$temp_grades->subjdesc }}</td>
                                                    <td class="text-center align-middle">
                                                        @if($temp_grades->q1 != null)
                                                            {{$temp_grades->q1}}
                                                        @else
                                                            @php
                                                                $with_final_rating = false;
                                                            @endphp
                                                        @endif
                                                        </td>
                                                    <td class="text-center align-middle">
                                                        @if($temp_grades->q2 != null)
                                                            {{$temp_grades->q2}}
                                                        @else
                                                            @php
                                                                $with_final_rating = false;
                                                    ...
                                                    <td class="text-center align-middle">
                                                        @if($with_final_rating)
                                                            {{number_format(($temp_grades->q1 + $temp_grades->q2) / 2 )}}
                                                        @endif
                                                        </td>
                                                    <td class="text-center align-middle">
                                                        @if($with_final_rating)
                                                            @if(number_format(($temp_grades->q1 + $temp_grades->q2) / 2 ) >= 75)
                                                                PASSED
                                                            @else
                                                                FAILED
                                                            @endif   
                                            ...
                                            @endforeach
                                            <tr>
                                                <td class="text-right align-middle">General Average</td>
                                                <td class="text-center align-middle"></td>
                                                <td class="text-center align-middle"></td>
                                                <td class="text-center align-middle">
                                                    @if($with_final_rating)
                                                        {{number_format($genave / count($grades))}}
                                                    @endif
                                                </td>
                                                <td class="text-center align-middle">
                                                    @if($with_final_rating)
                                                        @if(number_format($genave / count($grades)) >= 75)
                                                            PASSED
                                                        @else
                                                            FAILED
                                                        @endif   
